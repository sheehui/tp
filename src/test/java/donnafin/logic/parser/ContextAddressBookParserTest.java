...
public class ContextAddressBookParserTest {
    ...
    @Test
    public void executeParserStrategyCommand_AddressBookExit() throws Exception {
    ...
    @Test
    public void executeParserStrategyCommand_AddressBookHelp() throws Exception {
    ...
    @Test
    public void executeParserStrategyCommand_AddressBookUnrecognisedInput_throwsParseException() {
        assertThrows(ParseException.class, String.format(MESSAGE_INVALID_COMMAND_FORMAT, HelpCommand.MESSAGE_USAGE), ()
                -> context.executeParserStrategyCommand(""));
    }

    @Test
    public void executeParserStrategyCommand_AddressBookUnknownCommand_throwsParseException() {
        assertThrows(ParseException.class, MESSAGE_UNKNOWN_COMMAND, () -> context.executeParserStrategyCommand("unknownCommand"));
    }
