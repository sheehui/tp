...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withLiabilities("liability")
            .withCommision("commision")
            .withAssets("assets").build();
    ...
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withAddress("little india").withPolicies("policies")
            .withLiabilities("liability")
            .withCommision("commision")
            .withAssets("assets").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withEmail("hans@example.com").withAddress("chicago ave").withPolicies("policies")
            .withLiabilities("liability")
            .withCommision("commision")
            .withAssets("assets").build();
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withCommision(VALID_COMMISSION_AMY).withAssets(VALID_ASSET_ONE).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
            .withPolicies(VALID_POLICIES_ONE).withLiabilities(VALID_LIABILITY_BOB)
            .withCommision(VALID_COMMISSION_BOB).withAssets(VALID_ASSET_ONE).build();
