...
Let’s start by creating a new `RemarkCommand` class in the `src/main/java/donnafin/logic/command` directory.
...
You can refer to the changes in this [diff](https://github.com/ay2122S1-CS2103T-W16-1/tp/commit/35eb7286f18a029d39cb7a29df8f172a001e4fd8#diff-34ace715a8a8d2e5a66e71289f017b47).
...
Your code should look something like [this](https://github.com/ay2122S1-CS2103T-W16-1/tp/commit/35eb7286f18a029d39cb7a29df8f172a001e4fd8#diff-34ace715a8a8d2e5a66e71289f017b47) after you are done.

### Parse user input

Now let’s move on to writing a parser that will extract the index and remark from the input provided by the user.

Create a `RemarkCommandParser` class in the `donnafin.logic.parser` package. The class must extend the `Parser` interface.
...
[here](https://github.com/ay2122S1-CS2103T-W16-1/tp/commit/dc6d5139d08f6403da0ec624ea32bd79a2ae0cbf#diff-fc19ecee89c3732a62fbc8c840250508).
...
Create a new `Remark` in `donnafin.model.person`. Since a `Remark` is a field that is similar to `Address`, we can reuse a significant bit of code.

A copy-paste and search-replace later, you should have something like [this](https://github.com/ay2122S1-CS2103T-W16-1/tp/commit/4516e099699baa9e2d51801bd26f016d812dedcc#diff-af2f075d24dfcd333876f0fbce321f25). Note how `Remark` has no constrains and thus does not require input
validation.
...
Simply add the following to [`PersonCard`](https://github.com/ay2122S1-CS2103T-W16-1/tp/commit/850b78879582f38accb05dd20c245963c65ea599#diff-0c6b6abcfac8c205e075294f25e851fe).

**`donnafin.ui.PersonCard.java`:**
...
Then insert the following into [`main/resources/view/PersonListCard.fxml`](https://github.com/ay2122S1-CS2103T-W16-1/tp/commit/850b78879582f38accb05dd20c245963c65ea599#diff-12580431f55d7880578aa4c16f249e71).
...
Refer to [this commit](https://github.com/ay2122S1-CS2103T-W16-1/tp/commit/ce998c37e65b92d35c91d28c7822cd139c2c0a5c) and check that you have got everything in order!
...
:exclamation: You must delete DonnaFin’s storage file located at `/data/donnafin.json` before running it! Not doing so will cause AddressBook to default to an empty address book!

</div>

Check out [this commit](https://github.com/ay2122S1-CS2103T-W16-1/tp/commit/556cbd0e03ff224d7a68afba171ad2eb0ce56bbf)
...
Just add [this one line of code!](https://github.com/ay2122S1-CS2103T-W16-1/tp/commit/5b98fee11b6b3f5749b6b943c4f3bd3aa049b692)
...
be like the test cases in [here](https://github.com/ay2122S1-CS2103T-W16-1/tp/commit/fac8f3fd855d55831ca0cc73313b5943d49d4d6e#diff-d749de38392f7ea504da7824641ba8d9). Alternatively, you can get the help of IntelliJ to generate the skeletons of the test cases, as explained in the next section.
...
You should end up with a test that looks something like [this](https://github.com/ay2122S1-CS2103T-W16-1/tp/commit/fac8f3fd855d55831ca0cc73313b5943d49d4d6e#diff-d749de38392f7ea504da7824641ba8d9).
